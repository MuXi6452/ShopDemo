...
public class XRadioGroup extends LinearLayout {
            ...
            ((RadioButton) child).setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(mOnCheckedChangeListener != null){
                        mOnCheckedChangeListener.onCheckedChanged(XRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });
                ...
                if (view instanceof RadioButton) {
                    ...
                    ((RadioButton) button).setOnTouchListener(new OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            if(mOnCheckedChangeListener != null){
                                mOnCheckedChangeListener.onCheckedChanged(XRadioGroup.this, button.getId());
                            }
                            return true;
                        }
                    });
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(XRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(XRadioGroup.class.getName());
    }
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == XRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
